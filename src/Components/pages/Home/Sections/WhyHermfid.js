...
const WhyHermified=()=>{
   ...
   <h3 className="text-5xl font-medium pt-28 on ">Why Hemfrid?</h3>
...
<div className="flex my-3 sm:my-0 flex-col ">
    ...
    <div className=" ml-1 flex  flex-col items-center justify-center  ">
        <div className="bg-[hsla(0,0%,100%,.4)] rotateions  self-center  hover:bg-white   h-36 w-36 flex items-center justify-center rounded-full rotations">
...
<div className="flex flex-col my-3 sm:my-0 ">
    ...
    <div className=" ml-1 flex  flex-col items-center justify-center ">
        <div className="bg-[hsla(0,0%,100%,.4)]   self-center   h-36 w-36 flex items-center justify-center rounded-full rotations font-['Roboto']" >
