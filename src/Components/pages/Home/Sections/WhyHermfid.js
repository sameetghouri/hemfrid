...
const WhyHermified=()=>{
   ...
   <h3 className="text-5xl font-medium pt-28 on hover:animate-pulse">Why Hemfrid?</h3>
...
<div className="flex my-3 sm:my-0 flex-col ">
    ...
    <div className=" ml-1 flex  flex-col items-center justify-center ">
        <div className="bg-[hsla(0,0%,100%,.4)]  self-center   h-36 w-36 flex items-center justify-center rounded-full hover:animate-bounce">
        ...
        <h1 className="font-bold mt-9 text-lg leading-10 hover:animate-ping hover:delay-1000 hover:duration-500 hover:ease-linear">CUSTOMIZED FOR YOU</h1>
...
<div className="flex flex-col my-3 sm:my-0 ">
    ...
    <div className=" ml-1 flex  flex-col items-center justify-center">
        ...
        <h1 className="font-bold mt-9 text-lg leading-10 hover:animate-ping">FAIR TERMS AND CONDITIONS</h1>
...
<div className="flex  my-3 sm:my-0 flex-col">
    ...
    <div className=" ml-1 flex  flex-col items-center justify-center">
        ...
        <h1 className="font-bold mt-9 text-lg leading-10 hover:animate-ping">ALWAYS INSURED</h1>
