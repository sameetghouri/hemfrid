const MHero=()=>{
    ...
    return (<div>
        ...
        <img src="https://images.ctfassets.net/37vwfxlcawdb/69hHyQMNuGaEhmbFyirlC6/2e0e16f5ea1ed0bcc81df72e8e50ef68/Badrum-handfat-16-9.jpg?q=60&fm=jpg&w=2560"className=" relative z-0 w-full " alt="" srcset="" />
        </div>
        ...
        <div className=" z-0  w-[35%] absolute top-36 ml-20 text-white text-5xl font-medium font-['Young Serif']  lg:ml-28  xl:ml-24  2xl:ml-36">
            ...
            <p class="  text-start mt-1 ">cleaning when</p>
            <p class="  text-start mt-1 ">moving</p>
