...
return (
    ...
    <div className="bg-cover" style={{ backgroundImage: "url('https://images.ctfassets.net/37vwfxlcawdb/5o07S3NoPr2fdSPLpR0edY/c2cd40057ee5768a17c95212e714d9df/F_nsterputs.jpg?q=50&fm=avif&w=1200')" }}>
      


<div className=" mr-auto pt-48 md:px-28 px-10 text-white text-5xl font-medium font-['Young Serif'] ">

    <p className="text-start hover:text-gray-900">Time for <span className="text-lime-500">Window</span></p>
