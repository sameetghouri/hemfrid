...
<div className="text-base text-start">
  <p> Read more about <span className="underline font-semibold">Hemfrid Premium.</span> </p> 
    ...
    <img src="https://images.ctfassets.net/37vwfxlcawdb/3S4DCbeubjX5pskolguPgz/0b4a2ab5f8603e6ed56b0d2ec5f403bb/Blommor-1-1.jpg?q=50&fm=jpg&w=1200" className=" w-[100vw] h-[600px] " alt="pic_image" />
