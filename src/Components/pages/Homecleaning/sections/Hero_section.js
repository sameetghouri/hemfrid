const Hero = () => {
    ...
    return (
        <div className="bg-cover" style={{ backgroundImage: "url('https://images.ctfassets.net/37vwfxlcawdb/46LQQCY2RWA0EiWBlFxQyR/54772a23ef600af281aecae28cdd5160/home-cleaning1.jpg?q=50&fm=avif&w=1200')" }}>
