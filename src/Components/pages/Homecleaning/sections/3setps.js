...
<div class="h-fit bg-[#e2c6bb] ">
   <h3 className="text-5xl font-medium pt-28"><span className="animate-pulse duration-200 text-gray-500"><span className="font-bold text-white-800">3</span> Steps</span><span> to a simpler <span className="animate-bounce text-red-700">Everyday life</span></span></h3>
